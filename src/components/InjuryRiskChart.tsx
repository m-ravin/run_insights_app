                ...
                <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                        ...
                        <YAxis
                            ...
                            tickLine={false}
                            axisLine={false}
                            label={{ value: 'Relative risk of injury', angle: -90, position: 'insideRight', style: { textAnchor: 'middle', fill: '#9ca3af', fontSize: 12 } }}
                        />
                        <Tooltip
                        ...
                        {/* Background Zones */}
                        <ReferenceArea y1={1.5} y2={4} fill="#fecaca" fillOpacity={0.3} /> {/* High Risk */}
                        <ReferenceArea y1={1.3} y2={1.5} fill="#fde68a" fillOpacity={0.3} /> {/* Caution */}
                        <ReferenceArea y1={0.8} y2={1.3} fill="#bbf7d0" fillOpacity={0.3} /> {/* Optimal */}
                        <ReferenceArea y1={0} y2={0.8} fill="#86efac" fillOpacity={0.3} /> {/* Low */}
